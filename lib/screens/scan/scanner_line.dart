...
class _ScannerLineState extends State<ScannerLine> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacityAnimation = CurvedAnimation(parent: controller, curve: _OpacityCurve());
    controller.repeat();
  }
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) => Opacity(
          ...
          child: CustomPaint(
              size: const Size(double.infinity, double.infinity), painter: _LinePainter(offsetAnimation.value, widget.color))));
